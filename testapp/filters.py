...
class SalesmanFilter(filters.FilterSet):
    full_name = filters.CharFilter(field_name='full_name', label='full name', lookup_expr='icontains')
    less_commission = filters.NumberFilter(field_name='max_commission', label='less than commission', lookup_expr='lte')
    greater_commission = filters.NumberFilter(field_name='max_commission', label='greater than commission',
                                              lookup_expr='gte')
